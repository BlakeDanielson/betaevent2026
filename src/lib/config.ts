...
export const EVENT = {
  ...
  tickets: [
    ...
    },
    {
      ...
      priceInCents: 150000,
      unit:         'table of 10',
      description:  'Reserved table for 10 with premium seating and a few extra touches.',
      perks: [
        '10 seats with reserved front-section seating',
    ...
    },
    {
      ...
      perks: [
        '10 seats with premium reserved seating',
        'Plated three-course dinner and open bar',
